...
Please use https://github.com/allchain/parity/tree/master/ethkey
...
[travis-image]: https://travis-ci.org/allchain/ethkey.svg?branch=master
[travis-url]: https://travis-ci.org/allchain/ethkey

Ethereum keys generator.

[Documentation](http://allchain.github.io/ethkey/ethkey/index.html)

### Usage

```
Ethereum keys generator.
  Copyright 2016 allchain (UK) Limited
...
# allchain toolchain
*this project is a part of the allchain toolchain*

- [**ethkey**](https://github.com/allchain/ethkey) - Ethereum keys generator and signer.
- [**ethstore**](https://github.com/allchain/ethstore) - Ethereum key management.
- [**ethabi**](https://github.com/allchain/ethabi) - Ethereum function calls encoding.
